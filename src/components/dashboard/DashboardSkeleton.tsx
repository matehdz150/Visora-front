...
export function DashboardSkeleton() {
  return (
    <motion.div variants={loadingVariants} initial="initial" animate="animate" exit="exit" style={{ display: "flex", minHeight: "100vh", background: "#050505" }}>
      <SidebarSkeleton />
      <main className="dash-main" style={{ marginLeft: "250px", flex: 1, minHeight: "100vh" }}>
        <div className="dash-page" style={{ maxWidth: "1180px", margin: "0 auto", padding: "40px 44px 80px" }}>
          ...
          <div className="r-stack" style={{ display: "grid", gridTemplateColumns: "1.35fr 0.9fr", gap: "22px", marginTop: "34px", alignItems: "start" }}>
