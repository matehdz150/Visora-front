      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ paddingLeft: "22px" }}>
              <span style={{ color: "#8fa0d8" }}>&quot;safe&quot;</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>:</span>{" "}
              <span style={{ color: "#ff9b9b" }}>false</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>,</span>
            </div>
            <div style={{ paddingLeft: "22px" }}>
              <span style={{ color: "#8fa0d8" }}>&quot;action&quot;</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>:</span>{" "}
              <span style={{ color: "#c7d2ff" }}>&quot;reject&quot;</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>,</span>
            </div>
            <div style={{ paddingLeft: "22px" }}>
              <span style={{ color: "#8fa0d8" }}>&quot;riskScore&quot;</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>:</span>{" "}
              <span style={{ color: "#aebfff" }}>92</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>,</span>
            </div>
            <div style={{ paddingLeft: "22px" }}>
              <span style={{ color: "#8fa0d8" }}>&quot;category&quot;</span>
              <span style={{ color: "rgba(255,255,255,0.4)" }}>:</span>{" "}
              <span style={{ color: "#c7d2ff" }}>&quot;violence&quot;</span>
            </div>
            <div style={{ color: "rgba(255,255,255,0.35)" }}>{"}"}</div>
          </div>
        </div>
