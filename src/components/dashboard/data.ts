 ...
 */
import type { ApiKey, Label, ModLog, Project, RedactionSettings, VerifySettings } from "./types";
...
const VERIFY_DEFAULTS: VerifySettings = {
...
export const PROJECTS: Project[] = [
  { projectType: "moderation", redactionSettings: REDACTION_DEFAULTS, verifySettings: VERIFY_DEFAULTS, id: "proj_marketplace", name: "Marketplace", planId: "pro", mode: "balanced", monthMods: "48,210", created: "Jan 12, 2025", updated: "Jun 16, 02:32 PM", compliancePack: "marketplace" },
  { projectType: "moderation", redactionSettings: REDACTION_DEFAULTS, verifySettings: VERIFY_DEFAULTS, id: "proj_community", name: "Community", planId: "pro", mode: "strict", monthMods: "92,540", created: "Feb 03, 2025", updated: "Jun 16, 01:58 PM", compliancePack: "social" },
  { projectType: "moderation", redactionSettings: REDACTION_DEFAULTS, verifySettings: VERIFY_DEFAULTS, id: "proj_mobile", name: "Mobile App", planId: "free", mode: "balanced", monthMods: "812", created: "Mar 21, 2025", updated: "Jun 16, 09:02 AM" },
  { projectType: "moderation", redactionSettings: REDACTION_DEFAULTS, verifySettings: VERIFY_DEFAULTS, id: "proj_avatars", name: "Avatars", planId: "free", mode: "relaxed", monthMods: "230", created: "Apr 09, 2025", updated: "Jun 15, 10:19 PM", compliancePack: "dating" },
  { projectType: "moderation", redactionSettings: REDACTION_DEFAULTS, verifySettings: VERIFY_DEFAULTS, id: "proj_forum", name: "Forum", planId: "pro", mode: "strict", monthMods: "27,995", created: "May 17, 2025", updated: "Jun 15, 09:44 PM", compliancePack: "kids" },
  { projectType: "moderation", redactionSettings: REDACTION_DEFAULTS, verifySettings: VERIFY_DEFAULTS, id: "proj_onboarding", name: "Onboarding", planId: "free", mode: "balanced", monthMods: "514", created: "Jun 01, 2025", updated: "Jun 10, 10:31 AM" },
];
