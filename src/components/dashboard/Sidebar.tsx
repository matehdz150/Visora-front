  ...
  return (
    <motion.aside variants={sidebarVariants} initial="initial" animate="animate" className={"dash-sidebar" + (mobileOpen ? " dash-sidebar-open" : "")} style={{ position: "fixed", top: 0, left: 0, bottom: 0, width: "250px", background: "#0b0b0b", borderRight: "1px solid rgba(255,255,255,0.08)", display: "flex", flexDirection: "column", zIndex: 20 }}>
      ...
      <div style={{ marginTop: "auto", padding: "14px 14px 16px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        <button style={{ display: "flex", alignItems: "center", gap: "10px", width: "100%", padding: "9px 10px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "10px", cursor: "pointer", marginBottom: "10px", color: "#fff", fontFamily: "inherit" }}>
          <span style={{ width: "24px", height: "24px", borderRadius: "6px", background: "linear-gradient(135deg,#2a2d36,#15161b)", border: "1px solid rgba(255,255,255,0.1)", flexShrink: 0 }} />
        ...
        <button onClick={onSignOut} style={{ width: "100%", marginTop: "10px", padding: "8px 10px", borderRadius: "9px", border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.025)", color: "rgba(255,255,255,0.62)", fontFamily: "inherit", fontSize: "12px", cursor: "pointer" }}>Sign out</button>
      </div>
    </motion.aside>
  );
}
