  ...
  return (
    <>
      ...
      <motion.div
        ...
        style={{ position: "fixed", left: "50%", top: "50%", translate: "-50% -50%", zIndex: 71, width: "420px", maxWidth: "calc(100vw - 40px)", background: "#0f0f0f", border: "1px solid rgba(255,255,255,0.12)", borderRadius: "16px", padding: "24px", boxShadow: "0 34px 90px rgba(0,0,0,0.62)" }}
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end", gap: "10px", marginTop: "24px" }}>
          <button onClick={onCancel} style={{ padding: "9px 14px", borderRadius: "9px", border: "1px solid rgba(255,255,255,0.12)", background: "rgba(255,255,255,0.03)", color: "rgba(255,255,255,0.72)", fontFamily: "inherit", fontSize: "13px", cursor: "pointer" }}>{cancelLabel}</button>
